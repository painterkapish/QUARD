...
const scheduleData = {
  day1: {
    ...
    events: [
      ...
      { time: "13:15 – 14:15", title: "LUNCH BREAK", type: "Break" },
      { time: "14:15 – 15:30", title: "SESSION 3", type: "Technical Session" },
      { time: "15:30 – 15:45", title: "TEA BREAK", type: "Break" },
      { time: "15:45 – 17:00", title: "SESSION 4", type: "Technical Session" },
    ],
  },
  day2: {
    date: "March 11, 2026",
    events: [
      { time: "10:30 – 11:45", title: "SESSION 5", type: "Technical Session" },
      { time: "11:45 – 12:00", title: "TEA Break", type: "Break" },
      { time: "12:00 – 13:15", title: "SESSION 6", type: "Technical Session" },
      { time: "13:15 – 14:15", title: "Lunch Break", type: "Break" },
      { time: "14:15 – 15:30", title: "SESSION 7", type: "Technical Session" },
      { time: "15:30 – 15:45", title: "TEA Break", type: "Break" },
      { time: "15:45 – 17:00", title: "SESSION 8", type: "Technical Session" },
      { time: "17:30 – 18:00", title: "Valedictory", type: "General" },
